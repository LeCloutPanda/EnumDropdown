...
public class EnumDropdown : BasePlugin
{
	...
	{
        showMoreEnumInfo = Config.Bind("EnumDropdown", "showMoreEnumInfo", false, new ConfigDescription("Show more information about enums in the selector", null, new ConfigLocale("Settings.dev.lecloutpanda.enumdropdown.showMoreEnumInfo.Key", "Settings.dev.lecloutpanda.enumdropdown.showMoreEnumInfo.Description")));
    ...
    private static void BuildFlagUI<E>(UIBuilder ui, IField target, EnumMemberEditor editor) where E : struct, Enum
    {
        ...
        string format = showMoreEnumInfo.Value ? "{0:d}: {0}" : "{0}";
    ...
    private static void PopulateValues<E>(UIBuilder ui, Slot valuesRoot, IField target, EnumMemberEditor editor) where E : struct, Enum
    {
        ...
        foreach (string name in names)
        {
            ...
            string valueLabel = showMoreEnumInfo.Value ? string.Format("{0:d}: {1}", value, name) : name;
